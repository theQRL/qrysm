...
func InitializeFromProtoDeneb(st *zondpb.BeaconStateDeneb) (state.BeaconState, error) {
	return InitializeFromProtoUnsafeDeneb(proto.Clone(st).(*zondpb.BeaconStateDeneb))
}
...
// and sets them as fields of the BeaconState type.
func InitializeFromProtoUnsafeDeneb(st *zondpb.BeaconStateDeneb) (state.BeaconState, error) {
	if st == nil {
		return nil, errors.New("received nil state")
	}
