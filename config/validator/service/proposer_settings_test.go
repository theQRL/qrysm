...
func Test_Proposer_Setting_Cloning(t *testing.T) {
	...
	feeRecipient0, err := common.NewAddressFromString("Z50155530FCE8a85ec7055A5F8b2bE214B3DaeFd3")
	require.NoError(t, err)
	feeRecipient1, err := common.NewAddressFromString("Z6e35733c5af9B61374A128e6F85f553aF09ff89A")
	require.NoError(t, err)
	...
	t.Run("Happy Path Cloning", func(t *testing.T) {
		...
		newFeeRecipient, err := common.NewAddressFromString("Z44455530FCE8a85ec7055A5F8b2bE214B3DaeFd3")
		require.NoError(t, err)
