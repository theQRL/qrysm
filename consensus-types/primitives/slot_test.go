...
func TestSlot_Mul(t *testing.T) {
	tests := []struct {
		...
		{a: 1 << 32, b: 1 << 32, res: 0, panicMsg: mathqrysm.ErrMulOverflow.Error()},
		{a: 1 << 62, b: 2, res: 9223372036854775808},
		{a: 1 << 62, b: 4, res: 0, panicMsg: mathqrysm.ErrMulOverflow.Error()},
		{a: 1 << 63, b: 1, res: 9223372036854775808},
		{a: 1 << 63, b: 2, res: 0, panicMsg: mathqrysm.ErrMulOverflow.Error()},
	}
...
func TestSlot_Div(t *testing.T) {
	tests := []struct {
		...
		{a: 0, b: 1, res: 0},
		{a: 1, b: 0, res: 0, panicMsg: mathqrysm.ErrDivByZero.Error()},
		{a: 1 << 32, b: 1 << 32, res: 1},
...
func TestSlot_Add(t *testing.T) {
	tests := []struct {
		...
		{a: 1 << 63, b: 1 << 63, res: 0, panicMsg: mathqrysm.ErrAddOverflow.Error()},
		{a: 1 << 63, b: 1, res: 9223372036854775809},
		{a: math.MaxUint64, b: 1, res: 0, panicMsg: mathqrysm.ErrAddOverflow.Error()},
...
func TestSlot_Sub(t *testing.T) {
	tests := []struct {
		...
		{a: 1, b: 0, res: 1},
		{a: 0, b: 1, res: 0, panicMsg: mathqrysm.ErrSubUnderflow.Error()},
		...
		{a: math.MaxUint64 - 1, b: math.MaxUint64, res: 0, panicMsg: mathqrysm.ErrSubUnderflow.Error()},
		{a: math.MaxUint64, b: 0, res: math.MaxUint64},
