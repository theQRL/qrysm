...
func GeneratePreminedGenesisState(ctx context.Context, genesisTime, numValidators uint64, e1d *zondpb.Eth1Data) (*zondpb.BeaconState, []*zondpb.Deposit, error) {
...
func GeneratePreminedGenesisStateFromDepositData(
	ctx context.Context, genesisTime uint64, depositData []*zondpb.Deposit_Data, depositDataRoots [][]byte, e1d *zondpb.Eth1Data,
	...
	beaconState, err := coreState.PreminedGenesisBeaconState(ctx, deposits, genesisTime, &zondpb.Eth1Data{
		DepositRoot:  root[:],
