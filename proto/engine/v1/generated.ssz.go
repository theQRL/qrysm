...
// Hash: fced49d89d531c6ed76a556b20a114e0d00be68ee445ee80688c928b5b120dd3
package enginev1
...
func (w *Withdrawal) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'ValidatorIndex'
	w.ValidatorIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[8:16]))
