...
func (PayloadStatus_Status) EnumDescriptor() ([]byte, []int) {
	return file_proto_engine_v1_execution_engine_proto_rawDescGZIP(), []int{10, 0}
}
...
var file_proto_engine_v1_execution_engine_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x73, 0x22, 0xa5, 0x02, 0x0a, 0x13, 0x50,
	...
	0x6f, 0x74, 0x22, 0x90, 0x02, 0x0a, 0x0d, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x74,
	...
	0x61, 0x73, 0x68, 0x22, 0xcf, 0x01, 0x0a, 0x0a, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77,
	0x61, 0x6c, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x71, 0x0a, 0x0f, 0x76, 0x61, 0x6c, 0x69,
	...
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x43, 0x0a, 0x14, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67,
...
var file_proto_engine_v1_execution_engine_proto_goTypes = []interface{}{
	...
	(*PayloadAttributesV3)(nil),              // 10: theqrl.engine.v1.PayloadAttributesV3
	(*PayloadStatus)(nil),                    // 11: theqrl.engine.v1.PayloadStatus
	(*ForkchoiceState)(nil),                  // 12: theqrl.engine.v1.ForkchoiceState
	(*Withdrawal)(nil),                       // 13: theqrl.engine.v1.Withdrawal
	(*ExchangeCapabilities)(nil),             // 14: theqrl.engine.v1.ExchangeCapabilities
}
var file_proto_engine_v1_execution_engine_proto_depIdxs = []int32{
	13, // 0: theqrl.engine.v1.ExecutionPayloadBodyV1.withdrawals:type_name -> theqrl.engine.v1.Withdrawal
	13, // 1: theqrl.engine.v1.ExecutionPayloadCapella.withdrawals:type_name -> theqrl.engine.v1.Withdrawal
	3,  // 2: theqrl.engine.v1.ExecutionPayloadCapellaWithValue.payload:type_name -> theqrl.engine.v1.ExecutionPayloadCapella
	13, // 3: theqrl.engine.v1.PayloadAttributesV2.withdrawals:type_name -> theqrl.engine.v1.Withdrawal
	13, // 4: theqrl.engine.v1.PayloadAttributesV3.withdrawals:type_name -> theqrl.engine.v1.Withdrawal
	0,  // 5: theqrl.engine.v1.PayloadStatus.status:type_name -> theqrl.engine.v1.PayloadStatus.Status
