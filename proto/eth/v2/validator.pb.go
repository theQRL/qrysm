...
type SyncCommitteeSubscription struct {
	...
	UntilEpoch           github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch          `protobuf:"varint,3,opt,name=until_epoch,json=untilEpoch,proto3" json:"until_epoch,omitempty" cast-type:"github.com/theQRL/qrysm/v4/consensus-types/primitives.Epoch"`
}
...
type ContributionAndProof struct {
	...
	AggregatorIndex github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,opt,name=aggregator_index,json=aggregatorIndex,proto3" json:"aggregator_index,omitempty" cast-type:"github.com/theQRL/qrysm/v4/consensus-types/primitives.ValidatorIndex"`
