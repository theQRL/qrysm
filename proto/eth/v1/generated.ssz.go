...
// Hash: 47e0e5a492705f0ef8f749f51323e51047a1a4e6aad686e5b9a3abd5786930f5
package v1
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (1) 'Index'
	a.Index = github_com_cyyber_qrysm_v4_consensus_types_primitives.CommitteeIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'ActivationEligibilityEpoch'
	v.ActivationEligibilityEpoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[89:97]))

	// Field (5) 'ActivationEpoch'
	v.ActivationEpoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[97:105]))

	// Field (6) 'ExitEpoch'
	v.ExitEpoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[105:113]))

	// Field (7) 'WithdrawableEpoch'
	v.WithdrawableEpoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[113:121]))
