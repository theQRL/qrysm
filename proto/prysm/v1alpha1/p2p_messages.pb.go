...
type Status struct {
	...
	FinalizedEpoch github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch `protobuf:"varint,3,opt,name=finalized_epoch,json=finalizedEpoch,proto3" json:"finalized_epoch,omitempty" cast-type:"github.com/cyyber/qrysm/v4/consensus-types/primitives.Epoch"`
	HeadRoot       []byte                                                      `protobuf:"bytes,4,opt,name=head_root,json=headRoot,proto3" json:"head_root,omitempty" ssz-size:"32"`
	HeadSlot       github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot  `protobuf:"varint,5,opt,name=head_slot,json=headSlot,proto3" json:"head_slot,omitempty" cast-type:"github.com/cyyber/qrysm/v4/consensus-types/primitives.Slot"`
}
...
func (x *Status) GetFinalizedEpoch() github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch {
	if x != nil {
...
func (x *Status) GetHeadSlot() github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot {
	if x != nil {
		return x.HeadSlot
	}
...
type BeaconBlocksByRangeRequest struct {
	...
	StartSlot github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot `protobuf:"varint,1,opt,name=start_slot,json=startSlot,proto3" json:"start_slot,omitempty" cast-type:"github.com/cyyber/qrysm/v4/consensus-types/primitives.Slot"`
...
func (x *BeaconBlocksByRangeRequest) GetStartSlot() github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot {
	if x != nil {
		return x.StartSlot
	}
	return github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot(0)
...
type ENRForkID struct {
	...
	NextForkEpoch     github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch `protobuf:"varint,3,opt,name=next_fork_epoch,json=nextForkEpoch,proto3" json:"next_fork_epoch,omitempty" cast-type:"github.com/cyyber/qrysm/v4/consensus-types/primitives.Epoch"`
}
...
func (x *ENRForkID) GetNextForkEpoch() github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch {
	if x != nil {
...
var file_proto_prysm_v1alpha1_p2p_messages_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x42, 0x94, 0x01, 0x0a, 0x19, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72,
	0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31,
