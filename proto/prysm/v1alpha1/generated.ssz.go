...
// Hash: aa996a4020f9101d04740136bc25a694ea7f64007651fc29ffddf55d27ace545
package eth
...
func (a *Attestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Signature'
	if size := len(a.Signature); size != 4595 {
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	if cap(a.Signature) == 0 {
		a.Signature = make([]byte, 0, len(buf[132:4727]))
	}
	a.Signature = append(a.Signature, buf[132:4727]...)
...
func (a *AggregateAttestationAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	a.AggregatorIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	a.Slot = github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'CommitteeIndex'
	a.CommitteeIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.CommitteeIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (c *Checkpoint) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Epoch'
	c.Epoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[0:8]))
...
func (b *BeaconBlock) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	b.Slot = github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'ProposerIndex'
	b.ProposerIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (b *BeaconBlockBody) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.RandaoReveal); size != 2592 {
		err = ssz.ErrBytesLengthFn("--.RandaoReveal", size, 2592)
		return
	}
...
func (b *BeaconBlockBody) UnmarshalSSZ(buf []byte) error {
	...
	if cap(b.RandaoReveal) == 0 {
		b.RandaoReveal = make([]byte, 0, len(buf[0:2592]))
	}
	b.RandaoReveal = append(b.RandaoReveal, buf[0:2592]...)

	// Field (1) 'Eth1Data'
	if b.Eth1Data == nil {
		b.Eth1Data = new(Eth1Data)
	}
	if err = b.Eth1Data.UnmarshalSSZ(buf[2592:2664]); err != nil {
		return err
	}

	// Field (2) 'Graffiti'
	if cap(b.Graffiti) == 0 {
		b.Graffiti = make([]byte, 0, len(buf[2664:2696]))
	}
	b.Graffiti = append(b.Graffiti, buf[2664:2696]...)

	// Offset (3) 'ProposerSlashings'
	if o3 = ssz.ReadOffset(buf[2696:2700]); o3 > size {
		return ssz.ErrOffset
	}
	...
	// Offset (4) 'AttesterSlashings'
	if o4 = ssz.ReadOffset(buf[2700:2704]); o4 > size || o3 > o4 {
		return ssz.ErrOffset
	}

	// Offset (5) 'Attestations'
	if o5 = ssz.ReadOffset(buf[2704:2708]); o5 > size || o4 > o5 {
		return ssz.ErrOffset
	}

	// Offset (6) 'Deposits'
	if o6 = ssz.ReadOffset(buf[2708:2712]); o6 > size || o5 > o6 {
		return ssz.ErrOffset
	}

	// Offset (7) 'VoluntaryExits'
	if o7 = ssz.ReadOffset(buf[2712:2716]); o7 > size || o6 > o7 {
		return ssz.ErrOffset
	}
...
func (b *BeaconBlockBodyAltair) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.SyncAggregate.UnmarshalSSZ(buf[2716:7375]); err != nil {
		return err
	}
...
func (v *VoluntaryExit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Epoch'
	v.Epoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'ValidatorIndex'
	v.ValidatorIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[8:16]))
...
func (i *IndexedAttestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Signature'
	if size := len(i.Signature); size != 4595 {
		err = ssz.ErrBytesLengthFn("--.Signature", size, 4595)
		return
	}
...
func (i *IndexedAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if cap(i.Signature) == 0 {
		i.Signature = make([]byte, 0, len(buf[132:4727]))
	}
	i.Signature = append(i.Signature, buf[132:4727]...)
...
func (s *SyncAggregate) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(s.SyncCommitteeSignature); size != 4595 {
		err = ssz.ErrBytesLengthFn("--.SyncCommitteeSignature", size, 4595)
		return
	}
...
func (s *SyncAggregate) UnmarshalSSZ(buf []byte) error {
	...
	if cap(s.SyncCommitteeSignature) == 0 {
		s.SyncCommitteeSignature = make([]byte, 0, len(buf[64:4659]))
	}
	s.SyncCommitteeSignature = append(s.SyncCommitteeSignature, buf[64:4659]...)
...
func (b *BeaconBlockBodyBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (9) 'ExecutionPayload'
	if o9 = ssz.ReadOffset(buf[7375:7379]); o9 > size || o7 > o9 {
		return ssz.ErrOffset
	}
...
func (b *BeaconBlockBodyCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.BlsToExecutionChanges) * 7215
...
func (b *BeaconBlockBodyCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (10) 'BlsToExecutionChanges'
	if o10 = ssz.ReadOffset(buf[7379:7383]); o10 > size || o9 > o10 {
		return ssz.ErrOffset
	}
	...
	// Field (10) 'BlsToExecutionChanges'
	{
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.BlsToExecutionChanges[ii].UnmarshalSSZ(buf[ii*7215 : (ii+1)*7215]); err != nil {
				return err
			}
		}
	}
...
func (b *BeaconBlockBodyCapella) SizeSSZ() (size int) {
	...
	// Field (10) 'BlsToExecutionChanges'
	size += len(b.BlsToExecutionChanges) * 7215
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Slot'
	b.Slot = github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[40:48]))
...
func (b *BeaconStateAltair) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687381:4017077]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[4017077:5346773]); err != nil {
		return err
	}
...
func (f *Fork) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Epoch'
	f.Epoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))
...
func (p *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'InclusionDelay'
	p.InclusionDelay = github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[132:140]))

	// Field (3) 'ProposerIndex'
	p.ProposerIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[140:148]))
...
func (s *SyncCommittee) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(s.AggregatePubkey); size != 2592 {
		err = ssz.ErrBytesLengthFn("--.AggregatePubkey", size, 2592)
		return
	}
...
func (s *SyncCommittee) UnmarshalSSZ(buf []byte) error {
	...
	if cap(s.AggregatePubkey) == 0 {
		s.AggregatePubkey = make([]byte, 0, len(buf[1327104:1329696]))
	}
	s.AggregatePubkey = append(s.AggregatePubkey, buf[1327104:1329696]...)
...
func (s *SyncAggregatorSelectionData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	s.Slot = github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))
...
func (b *BeaconStateBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[5346773:5346777]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[5346777:5346785])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[5346785:5346793]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[5346793:5346797]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}
...
func (s *Status) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'FinalizedEpoch'
	s.FinalizedEpoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[36:44]))
	...
	// Field (4) 'HeadSlot'
	s.HeadSlot = github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[76:84]))
...
func (b *BeaconBlocksByRangeRequest) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'StartSlot'
	b.StartSlot = github_com_cyyber_qrysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[0:8]))
...
func (e *ENRForkID) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'NextForkEpoch'
	e.NextForkEpoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[8:16]))
...
func (s *SyncCommitteeMessage) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'ValidatorIndex'
	s.ValidatorIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[40:48]))
...
func (s *SyncCommitteeContribution) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[64:4659]))
	}
	s.Signature = append(s.Signature, buf[64:4659]...)
...
func (c *ContributionAndProof) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'AggregatorIndex'
	c.AggregatorIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'Contribution'
	if c.Contribution == nil {
		c.Contribution = new(SyncCommitteeContribution)
	}
	if err = c.Contribution.UnmarshalSSZ(buf[8:4667]); err != nil {
		return err
	}

	// Field (2) 'SelectionProof'
	if cap(c.SelectionProof) == 0 {
		c.SelectionProof = make([]byte, 0, len(buf[4667:9262]))
	}
	c.SelectionProof = append(c.SelectionProof, buf[4667:9262]...)
...
func (s *SignedContributionAndProof) UnmarshalSSZ(buf []byte) error {
	...
	if err = s.Message.UnmarshalSSZ(buf[0:9262]); err != nil {
		return err
	}

	// Field (1) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[9262:13857]))
	}
	s.Signature = append(s.Signature, buf[9262:13857]...)
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'ActivationEligibilityEpoch'
	v.ActivationEligibilityEpoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2633:2641]))

	// Field (5) 'ActivationEpoch'
	v.ActivationEpoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2641:2649]))

	// Field (6) 'ExitEpoch'
	v.ExitEpoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2649:2657]))

	// Field (7) 'WithdrawableEpoch'
	v.WithdrawableEpoch = github_com_cyyber_qrysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2657:2665]))
...
func (b *BLSToExecutionChange) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.FromBlsPubkey); size != 2592 {
		err = ssz.ErrBytesLengthFn("--.FromBlsPubkey", size, 2592)
		return
	}
...
func (b *BLSToExecutionChange) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'ValidatorIndex'
	b.ValidatorIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'FromBlsPubkey'
	if cap(b.FromBlsPubkey) == 0 {
		b.FromBlsPubkey = make([]byte, 0, len(buf[8:2600]))
	}
	b.FromBlsPubkey = append(b.FromBlsPubkey, buf[8:2600]...)

	// Field (2) 'ToExecutionAddress'
	if cap(b.ToExecutionAddress) == 0 {
		b.ToExecutionAddress = make([]byte, 0, len(buf[2600:2620]))
	}
	b.ToExecutionAddress = append(b.ToExecutionAddress, buf[2600:2620]...)
