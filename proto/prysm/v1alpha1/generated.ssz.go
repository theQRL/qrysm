...
// Hash: 65ead6376318e08f54ede522a2e53d291f55b4604e4a0d5b95c544b0d4618b7f
package eth
...
func (b *BeaconBlockBodyAltair) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.SyncAggregate.UnmarshalSSZ(buf[220:4879]); err != nil {
		return err
	}
...
func (b *BeaconBlockBodyBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (9) 'ExecutionPayload'
	if o9 = ssz.ReadOffset(buf[4879:4883]); o9 > size || o7 > o9 {
		return ssz.ErrOffset
	}
...
func (b *BeaconBlockBodyCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (10) 'BlsToExecutionChanges'
	if o10 = ssz.ReadOffset(buf[4883:4887]); o10 > size || o9 > o10 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[5346785:5346793]))
...
func (v *Validator) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'ActivationEligibilityEpoch'
	v.ActivationEligibilityEpoch = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2633:2641]))

	// Field (5) 'ActivationEpoch'
	v.ActivationEpoch = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2641:2649]))

	// Field (6) 'ExitEpoch'
	v.ExitEpoch = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2649:2657]))

	// Field (7) 'WithdrawableEpoch'
	v.WithdrawableEpoch = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[2657:2665]))
