...
// Hash: 678029a863228da1b52b8a899c33f6b727f4234f8f972631a2a9ae0f44424794
package eth
...
func (b *BeaconStateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[7995809:7995817]))
...
func (d *DilithiumToExecutionChange) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'ValidatorIndex'
	d.ValidatorIndex = github_com_cyyber_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[0:8]))
