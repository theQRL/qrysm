...
// Hash: f8b07fad843468ee2fd66387d7a55611e7a7f92d7360a0b7fc21463a1157b14c
package zond
...
func (b *BeaconStateAltair) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687381:2770325]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[2770325:2853269]); err != nil {
		return err
	}
...
func (b *BeaconStateBellatrix) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[2853269:2853273]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}
...
func (b *BeaconStateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[2853273:2853281])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_theQRL_qrysm_v4_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[2853281:2853289]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[2853289:2853293]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}
