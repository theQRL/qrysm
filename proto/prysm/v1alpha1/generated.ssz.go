...
// Hash: 99b573c13e73887f13c3751e1211c44d4f6200e7696f4bc1fe0d3ec6bc5bb316
package eth
...
func (i *IndexedAttestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'Signature'
	if size := len(i.Signature); size != 9410560 {
		err = ssz.ErrBytesLengthFn("--.Signature", size, 9410560)
		return
	}
...
func (i *IndexedAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if cap(i.Signature) == 0 {
		i.Signature = make([]byte, 0, len(buf[132:9410692]))
	}
	i.Signature = append(i.Signature, buf[132:9410692]...)

	// Offset (3) 'SignatureValidatorIndex'
	if o3 = ssz.ReadOffset(buf[9410692:9410696]); o3 > size || o0 > o3 {
		return ssz.ErrOffset
	}
