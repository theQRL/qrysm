...
type BeaconStateRequest_Slot struct {
	Slot github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot `protobuf:"varint,1,opt,name=slot,proto3,oneof" cast-type:"github.com/cyyber/qrysm/v4/consensus-types/primitives.Slot"`
}
