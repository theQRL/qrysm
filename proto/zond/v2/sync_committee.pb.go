...
func (x *SyncSubcommitteeValidators) Reset() {
	*x = SyncSubcommitteeValidators{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_zond_v2_sync_committee_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SyncSubcommitteeValidators) Descriptor() ([]byte, []int) {
	return file_proto_zond_v2_sync_committee_proto_rawDescGZIP(), []int{7}
}
...
var file_proto_zond_v2_sync_committee_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x42, 0x7b, 0x0a, 0x12,
	...
	0x76, 0x32, 0x3b, 0x7a, 0x6f, 0x6e, 0x64, 0xaa, 0x02, 0x0e, 0x54, 0x68, 0x65, 0x51, 0x52, 0x4c,
	0x2e, 0x5a, 0x6f, 0x6e, 0x64, 0x2e, 0x56, 0x32, 0xca, 0x02, 0x0e, 0x54, 0x68, 0x65, 0x51, 0x52,
	0x4c, 0x5c, 0x5a, 0x6f, 0x6e, 0x64, 0x5c, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_proto_zond_v2_sync_committee_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_proto_zond_v2_sync_committee_proto_goTypes = []interface{}{
	...
	(*SubmitPoolSyncCommitteeSignatures)(nil),    // 2: theqrl.zond.v2.SubmitPoolSyncCommitteeSignatures
	(*SyncCommitteeMessage)(nil),                 // 3: theqrl.zond.v2.SyncCommitteeMessage
	(*StateSyncCommitteesRequest)(nil),           // 4: theqrl.zond.v2.StateSyncCommitteesRequest
	(*StateSyncCommitteesResponse)(nil),          // 5: theqrl.zond.v2.StateSyncCommitteesResponse
	(*SyncCommitteeValidators)(nil),              // 6: theqrl.zond.v2.SyncCommitteeValidators
	(*SyncSubcommitteeValidators)(nil),           // 7: theqrl.zond.v2.SyncSubcommitteeValidators
}
var file_proto_zond_v2_sync_committee_proto_depIdxs = []int32{
	3, // 0: theqrl.zond.v2.SubmitSyncCommitteeSignaturesRequest.data:type_name -> theqrl.zond.v2.SyncCommitteeMessage
	3, // 1: theqrl.zond.v2.SubmitPoolSyncCommitteeSignatures.data:type_name -> theqrl.zond.v2.SyncCommitteeMessage
	6, // 2: theqrl.zond.v2.StateSyncCommitteesResponse.data:type_name -> theqrl.zond.v2.SyncCommitteeValidators
	7, // 3: theqrl.zond.v2.SyncCommitteeValidators.validator_aggregates:type_name -> theqrl.zond.v2.SyncSubcommitteeValidators
...
func file_proto_zond_v2_sync_committee_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_zond_v2_sync_committee_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_zond_v2_sync_committee_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
