...
// Source: github.com/theQRL/qrysm/v4/proto/prysm/v1alpha1 (interfaces: BeaconNodeValidatorClient,BeaconNodeValidator_WaitForChainStartClient,BeaconNodeValidator_WaitForActivationClient,BeaconNodeValidator_StreamDutiesClient)
...
func (m *MockBeaconNodeValidatorClient) StreamDuties(arg0 context.Context, arg1 *zond.DutiesRequest, arg2 ...grpc.CallOption) (zond.BeaconNodeValidator_StreamDutiesClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(zond.BeaconNodeValidator_StreamDutiesClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
