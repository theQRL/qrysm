...
func GenerateTestDenebBlockWithSidecar(t *testing.T, parent [32]byte, slot primitives.Slot, nblobs int) (blocks.ROBlock, []*zondpb.BlobSidecar) {
...
func GenerateTestDenebBlobSidecar(root [32]byte, block *zondpb.SignedBeaconBlockDeneb, index int, commitment []byte) *zondpb.BlobSidecar {
...
func ExtendBlocksPlusBlobs(t *testing.T, blks []blocks.ROBlock, size int) ([]blocks.ROBlock, []*zondpb.BlobSidecar) {
	blobs := make([]*zondpb.BlobSidecar, 0)
	if len(blks) == 0 {
