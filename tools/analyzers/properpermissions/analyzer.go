// Package properpermissions implements a static analyzer to ensure that Qrysm does not
...
const Doc = "Tool to enforce usage of Qrysm's internal file-writing utils instead of os.MkdirAll or ioutil.WriteFile"
