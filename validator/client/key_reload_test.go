...
func TestValidator_HandleKeyReload(t *testing.T) {
	...
	t.Run("active", func(t *testing.T) {
		...
		anyActive, err := v.HandleKeyReload(context.Background(), [][dilithium.CryptoPublicKeyBytes]byte{inactive.pub, active.pub})
	...
	t.Run("no active", func(t *testing.T) {
		...
		anyActive, err := v.HandleKeyReload(context.Background(), [][dilithium.CryptoPublicKeyBytes]byte{kp.pub})
		require.NoError(t, err)
	...
	t.Run("error when getting status", func(t *testing.T) {
		...
		_, err := v.HandleKeyReload(context.Background(), [][dilithium.CryptoPublicKeyBytes]byte{kp.pub})
