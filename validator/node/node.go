...
import (
	...
	g "github.com/cyyber/qrysm/v4/validator/graffiti"
	...
	validatormiddleware "github.com/cyyber/qrysm/v4/validator/rpc/apimiddleware"
...
func proposerSettings(cliCtx *cli.Context) (*validatorServiceConfig.ProposerSettings, error) {
	...
	if fileConfig.ProposerConfig != nil {
		...
		for key, option := range fileConfig.ProposerConfig {
			...
			vpSettings.ProposeConfig[bytesutil.ToBytes2592(decodedKey)] = &validatorServiceConfig.ProposerOption{
				FeeRecipientConfig: &validatorServiceConfig.FeeRecipientConfig{
